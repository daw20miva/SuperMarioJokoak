...
nav ul li a {
    ...
    </head><p><a href="index.php" style="text-decoration:none; color:white; font-size:20px;">Hasiera</a></p>
    <body style="text-align:center;">
    <div style="height:200px;">
</div>

<img src="../images/Small_Mario.png" style="width:200px;">
   
		<p style="color:white;"><?php echo $etiketa_produktua; ?></p>
		<p  style="color:white;"><?php echo $etiketa_id_baliogabea; ?></p>
	</body>
</html>
