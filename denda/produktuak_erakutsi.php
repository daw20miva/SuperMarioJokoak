...
nav ul li a {
    ...
    <br>
    <br>	
	<p style=" float: right;margin-right:2%;"><a href="index.php?hizkuntza=euskera" style="color:white; font-family: Nhas;">Euskera</a> | <a href="index.php?hizkuntza=erdera" style="color:white; font-family: Nhas;">Erdera</a></p>
	<br><br><div class="container border border-3 border-white">
	
        <div class="row">
		
<div class="col-md-12 text-center">
		<!--<h1 style="text-decoration: none; color: white;">Produktuen Katalogoa</h1>-->
...
<?php
		 foreach ($produktuak as $produktua) { ?>
			...
			<b><a href="./?id=<?php echo $produktua->getId() ?>" style="text-decoration: none; color: white;"><?php echo $produktua->getIzenburua() ?></a></b>
			<br><br>
			<img src="images/<?php echo $produktua->getId() ?>_produktua.png"  style="max-width: 200px">
			<br><br>
			<dd><p style="color:white; font-family: Nhas;"><?php echo $etiketa_xehetasunak . ": " . $produktua->getXehetasunak() ?>
			<dd><p style="color:white; font-family: Nhas;"><?php echo $etiketa_prezioa . ": " . $produktua->getPrezioa() ?> &euro;
			</div>
		<?php } ?></div>
		</dl>
		<a href="saskia" style="color:white; font-family: Nhas;"><?php echo $etiketa_saskia; ?></a>
		<?php
    $rowCount++;
