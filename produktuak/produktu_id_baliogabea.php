...
<img src="../images/Small_Mario.png" style="width:200px;">
        ...
        <h1 style="font-size:60px;color:white;">Produktu hau ez da existitzen</h1>  
        <p><a href="." style="text-decoration:none; color:white; font-size:20px;">Katalogoara bueltatu</a> </p>
        <p></p>
    </body>
</html>