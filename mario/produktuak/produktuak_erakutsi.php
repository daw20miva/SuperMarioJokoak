...
nav ul li a {
    ...
    <body>
        ...
        <ul>
            ...
            <li><a href="#">azken albisteak</a></li>
...
?>  
        ...
        <img src="../img/<?php echo $produktua->getId() ?>.png"> <br>
 <h2>  <?php echo $produktua->getPrezioa() ?> &euro;</h2>
        <a href="./?id=<?php echo $produktua->getId() ?>"><?php echo $produktua->getProduktu_izena() ?></a></dt>
